...
El modelo usa microdatos de la ENIEF 2023 y estima una regresión logística donde la variable dependiente identifica uso de métodos digitales frente a efectivo en transacciones cotidianas. Los resultados se reportan como efectos marginales promedio para que la lectura sea directa en puntos porcentuales: por eso “tener cuenta bancaria” se interpreta como un aumento aproximado de 17 pp en la probabilidad de usar medios digitales, manteniendo constantes las demás variables incluidas en el modelo.
</div>
</div>
